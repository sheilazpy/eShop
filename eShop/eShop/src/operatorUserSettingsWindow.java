...
public class operatorUserSettingsWindow extends JFrame {
	...
	private void jbInit() throws Exception {
		...
		updateButton.setBounds(179, 137, 106, 26);
		...
		deleteOperator.setBounds(10, 137, 137, 26);
	}
	...
	protected void updateButton_actionPerformed(ActionEvent e) {
		...
		databaseConnectWindow.dbPortal.executeNonQuery("UPDATE operators SET operator_password='" + currentOperatorPassword +
